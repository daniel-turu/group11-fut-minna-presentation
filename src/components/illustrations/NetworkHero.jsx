...
export default function NetworkHero() {
  return (
    <svg viewBox="0 0 400 300" className="w-full h-full text-white/10 z-0">
      ...
      {/* Lines connecting nodes (Animated) */}
      <motion.path
        ...
        d="M100,150 L200,80 L300,180 L350,100"
        stroke="url(#lineGrad)"
        strokeWidth="1.5"
        fill="none"
      />
      ...
      <circle
        ...
        strokeWidth="1"
        fill="none"
        className="opacity-0 animate-[ping_3s_infinite]"
      />
      <circle
        cx="350"
        cy="100"
        ...
        strokeWidth="1"
        fill="none"
        className="opacity-0 animate-[ping_4s_infinite]"
