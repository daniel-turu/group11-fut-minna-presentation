...
export default function Slide10() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center px-12 relative overflow-hidden">
            ...
            >
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-theme-purple/10 border border-theme-purple/20 text-theme-purple text-sm font-bold tracking-widest uppercase mb-6 shadow-sm">
                ...
                <p className="text-dark-300 text-xl font-medium max-w-2xl mx-auto">
            ...
            <div className="flex w-full max-w-5xl gap-8 z-10">
                ...
                >
                    {specs.map((spec, i) => (
                        <div key={i} className="glass-panel p-5 rounded-2xl border border-dark-700 border-l-4 border-l-theme-purple flex items-center justify-between group hover:-translate-y-1 transition-transform">
                            <div>
                                <span className="block text-dark-400 text-sm font-bold tracking-wider uppercase mb-1">{spec.label}</span>
                                <span className="block text-dark-200 text-xs font-medium">{spec.desc}</span>
                            </div>
                            <div className="text-3xl font-black text-theme-purple tracking-tighter">
                                {spec.value}
                            </div>
                        </div>
                    ))}
                ...
                <motion.div
                    ...
                    className="flex-[1.2] glass-panel p-8 rounded-3xl border border-dark-700 relative overflow-hidden group shadow-lg"
                >
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="p-4 bg-dark-800 border border-dark-700 shadow-sm rounded-2xl text-theme-purple">
                                <BrainCircuit className="w-8 h-8" />
                            </div>
                            <h3 className="text-3xl font-bold text-white leading-tight">AI-Driven <br />Intelligence</h3>
                        </div>

                        <p className="text-dark-200 text-lg leading-relaxed font-medium mb-8">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-center gap-3 text-sm font-bold text-dark-100 bg-dark-800/40 border border-dark-700 p-3 rounded-lg">
                                <ActivitySquare className="w-5 h-5 text-theme-blue" /> Machine Learning
                            </div>
                            <div className="flex items-center gap-3 text-sm font-bold text-dark-100 bg-dark-800/40 border border-dark-700 p-3 rounded-lg">
                                <Rocket className="w-5 h-5 text-theme-cyan" /> Sub-millisecond UX
                            </div>
                        </div>
                    </div>
                </motion.div>
