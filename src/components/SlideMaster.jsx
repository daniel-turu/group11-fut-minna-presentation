...
export default function SlideMaster({ current, total, onNext, onPrev, isFirst, isLast }) {
    return (
        <div className="mt-6 flex items-center justify-between px-4 z-50">
            <div className="text-dark-100/60 text-sm font-medium tracking-wider">
                {current ? (
                    ...
                    <span className="text-dark-100/30 uppercase tracking-[0.2em] font-bold text-xs">Overview</span>
                )}
            </div>
